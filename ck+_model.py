...
if __name__ == "__main__":
    ...
    # change input channels, AvgPool and classifier structure
    ...
    pretrained_vgg.cuda()
    # summary(pretrained_vgg, (1, 48, 48))
    ...
    trainer.train_loop(pretrained_vgg, dataloader['train'], dataloader['test'])
    ...
    # draw accuracy pictures for epochs
